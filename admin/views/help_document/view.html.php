 ...
 */
class SermondistributorViewHelp_document extends HtmlView
{
	/**
	...
	protected function addToolBar()
	{
		...
		ToolbarHelper::title( Text::_($isNew ? 'COM_SERMONDISTRIBUTOR_HELP_DOCUMENT_NEW' : 'COM_SERMONDISTRIBUTOR_HELP_DOCUMENT_EDIT'), 'pencil-2 article-add');
		...
		else
		{
			...
			else
			{
				...
				{
					ToolbarHelper::versions('com_sermondistributor.help_document', $this->item->id);
				}
				if ($this->canDo->get('help_document.create'))
				{
					ToolbarHelper::custom('help_document.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
				}
				ToolbarHelper::cancel('help_document.cancel', 'JTOOLBAR_CLOSE');
			}
		}
	...
	protected function setDocument()
	{
		...
		Html::_('stylesheet', "administrator/components/com_sermondistributor/assets/css/help_document.css", ['version' => 'auto']);
		Html::_('script', $this->script, ['version' => 'auto']);
		Html::_('script', "administrator/components/com_sermondistributor/views/help_document/submitbutton.js", ['version' => 'auto']);
