...
/------------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		Help_documentsModel.php
 ...
 * @since  1.6
 */
class Help_documentsModel extends ListModel
{
	/**
	...
	protected array $styles = [
		...
		'administrator/components/com_sermondistributor/assets/css/help_documents.css'
 	];
