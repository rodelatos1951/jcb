...
/------------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		Help_documentModel.php
 ...
 * @since  1.6
 */
class Help_documentModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_sermondistributor/assets/css/help_document.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_sermondistributor/js/help_document.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'help_document', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('help_document.delete', 'com_sermondistributor.help_document.' . (int) $record->id);
	}
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_sermondistributor.edit.help_document.data', []);
	...
	public function save($data)
	{
		...
		if (in_array($input->get('task'), array('apply', 'save', 'save2new')) && (int) $input->get('id') == 0)
		{
			if ($data['alias'] == null || empty($data['alias']))
			{
				...
				{
					$msg = Text::_('COM_SERMONDISTRIBUTOR_HELP_DOCUMENT_SAVE_WARNING');
				}
