...
/------------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		External_sourceModel.php
 ...
 * @since  1.6
 */
class External_sourceModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_sermondistributor/assets/css/external_source.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_sermondistributor/js/external_source.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'external_source', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('external_source.delete', 'com_sermondistributor.external_source.' . (int) $record->id);
	}
