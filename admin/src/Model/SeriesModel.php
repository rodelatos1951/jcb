 ...
 * @since  1.6
 */
class SeriesModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_sermondistributor/assets/css/series.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_sermondistributor/js/series.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'series', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('series.delete', 'com_sermondistributor.series.' . (int) $record->id);
	}
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_sermondistributor.edit.series.data', []);
