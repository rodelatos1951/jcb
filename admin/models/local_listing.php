 ...
 */
class SermondistributorModelLocal_listing extends AdminModel
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'local_listing', $prefix = 'SermondistributorTable', $config = [])
	{
	...
	protected function canDelete($record)
	{
		if (!empty($record->id))
		{
			...
			return $user->authorise('local_listing.delete', 'com_sermondistributor.local_listing.' . (int) $record->id);
		}
		return false;
	}
