...
$power_autoloader = JPATH_SITE . '/components/com_sermondistributor/helpers/powerloader.php';
...
abstract class SermondistributorHelper
{
	...
	**/
	 ...
	 */
	public static function getModel($name, $path = JPATH_COMPONENT_SITE, $Component = 'Sermondistributor', $config = [])
	{
		// fix the name
