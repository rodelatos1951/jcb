...
/----------------------------------------------------------------------------------------------------------------------------------*/
namespace TrueChristianChurch\Component\Sermondistributor\Site\View\Category;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function _prepareDocument(): void
	{
		...
		{
			$this->getDocument()->setMetadata('keywords', $this->category->metakey);
		}
		...
		{
			$this->getDocument()->setMetadata('robots', $this->category->robots);
		}
		...
		{
			$this->getDocument()->setMetaData('author', $this->category->created_by);
		}
