...
/----------------------------------------------------------------------------------------------------------------------------------*/
namespace TrueChristianChurch\Component\Sermondistributor\Site\View\Preacher;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function _prepareDocument(): void
	{
		...
		{
			$this->getDocument()->setDescription($this->preacher->metadesc);
		}
		...
		{
			$this->getDocument()->setMetadata('keywords', $this->preacher->metakey);
		}
		...
		{
			$this->getDocument()->setMetadata('robots', $this->preacher->robots);
		}
		...
		{
			$this->getDocument()->setMetaData('author', $this->preacher->created_by);
		}
